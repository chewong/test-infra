...
var (
	...
	aksMasterVMSize        = flag.String("aksengine-mastervmsize", "Standard_DS2_v2", "Azure Master VM size")
	aksAgentVMSize         = flag.String("aksengine-agentvmsize", "Standard_DS2_v2", "Azure Agent VM size")
	aksAdminUsername       = flag.String("aksengine-admin-username", "azureuser", "Admin username")
	aksAdminPassword       = flag.String("aksengine-admin-password", "AdminPassw0rd", "Admin password")
	aksAgentPoolCount      = flag.Int("aksengine-agentpoolcount", 2, "Azure Agent Pool Count")
	...
	aksSSHPublicKeyPath    = flag.String("aksengine-public-key", os.Getenv("AZURE_SSH_PUBLIC_KEY_FILE"), "Path to SSH Public Key")
	...
	aksCredentialsFile     = flag.String("aksengine-creds", os.Getenv("AZURE_CREDENTIALS"), "Path to credential file for Azure")
